...
rDownloadURL = {"main": "https://www.dropbox.com/scl/fi/t524cvkj7goqseafkq5h8/main_xtreamcodes_reborn.tar.gz?rlkey=1mae0takma45gd8kuphgq34sd&dl=1", "sub": "https://www.dropbox.com/scl/fi/ojvpsrdsjbb3wxqiekoin/sub_xtreamcodes_reborn.tar.gz?rlkey=vr06rkgwwfc7wktfqww27r5m1&dl=1"}
...
def installadminpanel():
    rURL = "https://github.com/topweytec/xtreamui_mirror/raw/main/release_22f.zip"
    ...
    rURL2 = "https://github.com/topweytec/xtreamui_mirror/raw/main/newstuff.zip"
...
def configure():
    ...
    os.system("wget -q https://github.com/topweytec/xtreamui_mirror/raw/main/nginx -O /home/xtreamcodes/iptv_xtream_codes/nginx/sbin/nginx")
    os.system("wget -q https://github.com/topweytec/xtreamui_mirror/raw/main/nginx_rtmp -O /home/xtreamcodes/iptv_xtream_codes/nginx_rtmp/sbin/nginx_rtmp")
    os.system("wget -q https://github.com/topweytec/xtreamui_mirror/raw/main/pid_monitor.php -O /home/xtreamcodes/iptv_xtream_codes/crons/pid_monitor.php")
    ...
    os.system("wget -q https://github.com/topweytec/xtreamui_mirror/raw/main/GeoLite2.mmdb -O /home/xtreamcodes/iptv_xtream_codes/GeoLite2.mmdb")
    os.system('chattr -f +i /home/xtreamcodes/iptv_xtream_codes/GeoLite2.mmdb > /dev/null')
...
if __name__ == "__main__":
    ...
    print "%s │ Telegram: https://t.me/+VuOXTQKjuAU0NTMx %s" % (col.OKGREEN, col.ENDC)
    print " "
